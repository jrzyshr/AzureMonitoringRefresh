...
# Old version pointing to WTH source
#Invoke-WebRequest -Uri "https://github.com/jrzyshr/AzureMonitoringRefresh/blob/main/xxx-AzureMonitoring/Student/Resources/sources/master.zip?raw=true" -OutFile $zipFileeShop
